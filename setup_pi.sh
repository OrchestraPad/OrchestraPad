...
echo "================================================"
echo "   Music Sheet Reader - Raspberry Pi Setup"
echo "================================================"
...
echo "$DESKTOP_CONTENT" > "$AUTOSTART_DIR/notenmappe.desktop"

# 2. Desktop Shortcut
DESKTOP_PATH="$HOME/Desktop/Notenmappe.desktop"
...
echo "   FERTIG!"
echo "================================================"
echo "1. Es liegt nun ein Icon 'Notenmappe' auf deinem Desktop."
